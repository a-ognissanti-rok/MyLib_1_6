...
public class NodesCounterDialogLogic : BaseNetLogic
{
    ...
    public void CountNodesInPage()
    {
        ...
        //var loadingAnimation = Owner.Get<Image>("Loading");
        ...
        // Set results to UI
        Label nodesCountValu = Owner.Get<Label>("Content/NodesCount/NodesCountValue");
        ...
        nodesCountValu.Text = nodesCount.ToString();
